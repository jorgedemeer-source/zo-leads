...
var ASSETS = ['./','./index.html','./manifest.webmanifest','./img/icon-192.png','./img/icon-512.png','./img/icon-180.png','./img/wordmark_white.svg','./img/icon_white.svg',
  './img/top_mirada.jpg','./img/top_producto.jpg','./img/bottom_polish.jpg','./img/bottom_mano.jpg','./img/who_polish.jpg','./img/inst_polish.jpg','./img/wordmark_cobalt.svg',
